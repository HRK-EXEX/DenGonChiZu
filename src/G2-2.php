...
function getCommentsByPostId($db, $postId) {
    try {
        $stmt = $db->prepare("SELECT c.comment_ID, c.content, c.date, c.user_id, u.user_name
                                FROM Comments c 
...
<body>
    <div class="parent">
        ...
        <div class="edit">
            <button onclick="location.href='G2-3.php?post_id=<?php echo urlencode($postId); ?>'" class="button-base proceed">編集</button>
        </div>
        <?php endif; ?>
        <div class="show-part">
